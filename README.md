...
wget https://github.com/PlebOne/nos/releases/latest/download/nos_1.1.6_amd64.deb

# Install the package
sudo dpkg -i nos_1.1.6_amd64.deb
...
- ARM64: `nos_1.1.6_arm64.deb`
- ARMv7: `nos_1.1.6_armhf.deb`
